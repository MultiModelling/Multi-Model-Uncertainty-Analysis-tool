...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" description="" esdlVersion="v2210" name="New Energy System" id="e4e87ec0-2c1c-4569-afc8-752bbddadbcc" version="14">
  ...
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="618bbae6-25a7-46d0-bd7d-c1eb70cb2d31">
    <area xsi:type="esdl:Area" name="Tholen" scope="MUNICIPALITY" id="GM0716">
      <asset xsi:type="esdl:PVInstallation" name="PVInstallation_1907" state="OPTIONAL" surfaceArea="7979" id="1907945a-5ffe-4c08-b9ce-9bc8689f943c">
        <costInformation xsi:type="esdl:CostInformation" id="c1ec6af9-b62b-40db-acdc-a84a7d2692ee">
          <investmentCosts xsi:type="esdl:SingleValue" id="2731c2a1-f70b-4db8-9f70-f531121d3745" value="10.315">
        ...
        <constraint xsi:type="esdl:RangedConstraint" id="d045e8d3-7f7b-40c5-a756-8c6534d6be2b" name="NewRangedConstraint" attributeReference="power">
          <range xsi:type="esdl:Range" minValue="20000.0" id="642eb1f7-22c8-4131-bf90-ff6e387a4a68" name="PV installed capacity range" maxValue="40000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" id="2b8f2157-4f95-4b2d-8944-cedc43a2cad9" description="Power in Watt" physicalQuantity="POWER" unit="WATT"/>
          </range>
        </constraint>
        <port xsi:type="esdl:OutPort" connectedTo="ad335aa5-2ebc-4148-85ac-b4276f64b7fc" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out" id="4c3f787e-df4f-4ab8-93ab-93dcde9827e2">
          <profile xsi:type="esdl:InfluxDBProfile" database="energy_profiles" measurement="standard_profiles" host="http://influxdb" id="6fc38691-9d02-4f58-bfde-455eb641cb82" endDate="2020-01-01T00:00:00.000000+0100" filters="" multiplier="28813.72" port="8086" field="Zon_deBilt" startDate="2019-01-01T00:00:00.000000+0100">
      ...
      <asset xsi:type="esdl:ElectricityDemand" name="ElectricityDemand_2f52" id="2f528ef6-186e-4937-9967-d277f78e858a">
        <port xsi:type="esdl:InPort" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="In" connectedTo="bdb51e39-6cbf-48b1-84ab-bc342c4449f0" id="54c99cc4-fbc2-4d94-bc78-994eedb2cded">
          <profile xsi:type="esdl:InfluxDBProfile" database="energy_profiles" measurement="standard_profiles" host="http://influxdb" id="0de8679f-b0c1-4b17-830e-25955007bb2c" endDate="2019-12-31T22:00:00.000000+0000" filters="" multiplier="100.0" port="8086" field="E3C" startDate="2018-12-31T23:00:00.000000+0000">
      ...
      <asset xsi:type="esdl:Export" power="100000.0" name="Export_ef9b" id="ef9b714e-ba35-4efb-9fbd-ff614af32c67">
        <costInformation xsi:type="esdl:CostInformation">
          <marginalCosts xsi:type="esdl:SingleValue" id="55738e39-2d19-4c33-820c-334de748b2bd" name="Export_ef9b-MarginalCosts" value="0.186"/>
        </costInformation>
