...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" description="" esdlVersion="v2210" name="New Energy System" id="e4e87ec0-2c1c-4569-afc8-752bbddadbcc" version="14">
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="bc6a175b-6e55-44b4-a664-d0fda633920a">
    ...
    <quantityAndUnits xsi:type="esdl:QuantityAndUnits" id="543ca49f-c1bf-4f20-95e6-3dd6e2bc2e28">
      <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" perMultiplier="KILO" multiplier="KILO" perUnit="WATT" unit="WATTHOUR" physicalQuantity="ENERGY" id="eb07bccb-203f-407e-af98-e687656a221d" description="Energy in kWh per kW"/>
    ...
    <area xsi:type="esdl:Area" id="GM0716" scope="MUNICIPALITY" name="Tholen">
      <asset xsi:type="esdl:PVInstallation" name="PVInstallation_1907" state="OPTIONAL" surfaceArea="7979" id="1907945a-5ffe-4c08-b9ce-9bc8689f943c">
        <costInformation xsi:type="esdl:CostInformation" id="c1ec6af9-b62b-40db-acdc-a84a7d2692ee">
          <investmentCosts xsi:type="esdl:SingleValue" id="2731c2a1-f70b-4db8-9f70-f531121d3745" value="10.933">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perMultiplier="KILO" perUnit="WATT" unit="EURO" physicalQuantity="COST" id="ed551dad-660a-4f65-84c6-3e108241a178" description="Cost in EUR/kW"/>
          </investmentCosts>
        ...
        <constraint xsi:type="esdl:RangedConstraint" name="NewRangedConstraint" attributeReference="power" id="d045e8d3-7f7b-40c5-a756-8c6534d6be2b">
          <range xsi:type="esdl:Range" name="PV installed capacity range" id="642eb1f7-22c8-4131-bf90-ff6e387a4a68" maxValue="40000.0" minValue="20000.0">
        ...
        <port xsi:type="esdl:OutPort" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out" id="4c3f787e-df4f-4ab8-93ab-93dcde9827e2" connectedTo="ad335aa5-2ebc-4148-85ac-b4276f64b7fc">
          <profile xsi:type="esdl:InfluxDBProfile" measurement="standard_profiles" id="6fc38691-9d02-4f58-bfde-455eb641cb82" endDate="2020-01-01T00:00:00.000000+0100" filters="" multiplier="28813.72" port="8086" field="Zon_deBilt" startDate="2019-01-01T00:00:00.000000+0100" host="http://influxdb" database="energy_profiles">
      ...
      <asset xsi:type="esdl:ElectricityDemand" name="ElectricityDemand_2f52" id="2f528ef6-186e-4937-9967-d277f78e858a">
        <port xsi:type="esdl:InPort" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="In" connectedTo="bdb51e39-6cbf-48b1-84ab-bc342c4449f0" id="54c99cc4-fbc2-4d94-bc78-994eedb2cded">
          <profile xsi:type="esdl:InfluxDBProfile" measurement="standard_profiles" id="0de8679f-b0c1-4b17-830e-25955007bb2c" endDate="2019-12-31T22:00:00.000000+0000" filters="" multiplier="100.0" port="8086" field="E3C" startDate="2018-12-31T23:00:00.000000+0000" host="http://influxdb" database="energy_profiles">
        ...
        <geometry xsi:type="esdl:Point" lat="51.54339257209525" CRS="WGS84" lon="4.229489564895631"/>
      </asset>
      <asset xsi:type="esdl:ElectricityNetwork" name="ElectricityNetwork_80e3" id="80e36970-0f1d-41f4-b371-f380ee3da8d3">
        ...
        <port xsi:type="esdl:OutPort" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out" id="bdb51e39-6cbf-48b1-84ab-bc342c4449f0" connectedTo="54c99cc4-fbc2-4d94-bc78-994eedb2cded 19f8133c-51e5-4406-99eb-5489138255d0"/>
        <geometry xsi:type="esdl:Point" lat="51.539896049575276" CRS="WGS84" lon="4.229875802993775"/>
      </asset>
      <asset xsi:type="esdl:Import" name="Import_bf48" id="bf483dd9-1f4e-4af1-9b23-ebf5eeae16d3" power="100000.0">
        <costInformation xsi:type="esdl:CostInformation"/>
        <port xsi:type="esdl:OutPort" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out" id="9f17b954-d511-42cc-a51e-ccf7b6fb2bea" connectedTo="ad335aa5-2ebc-4148-85ac-b4276f64b7fc"/>
        <geometry xsi:type="esdl:Point" lat="51.5383211921442" CRS="WGS84" lon="4.227418899536134"/>
      </asset>
      <asset xsi:type="esdl:Export" power="100000.0" name="Export_ef9b" id="ef9b714e-ba35-4efb-9fbd-ff614af32c67">
        <costInformation xsi:type="esdl:CostInformation">
          <marginalCosts xsi:type="esdl:SingleValue" id="55738e39-2d19-4c33-820c-334de748b2bd" value="0.169" name="Export_ef9b-MarginalCosts"/>
        </costInformation>
        ...
        <geometry xsi:type="esdl:Point" lat="51.537907449373336" CRS="WGS84" lon="4.228609800338746"/>
      </asset>
    </area>
  </instance>
</esdl:EnergySystem>
