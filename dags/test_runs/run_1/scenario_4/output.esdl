    ...
    <area xsi:type="esdl:Area" name="Tholen" id="GM0716" scope="MUNICIPALITY">
      <asset xsi:type="esdl:PVInstallation" name="PVInstallation_1907" surfaceArea="7979" state="OPTIONAL" id="1907945a-5ffe-4c08-b9ce-9bc8689f943c">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="c1ec6af9-b62b-40db-acdc-a84a7d2692ee">
          <investmentCosts xsi:type="esdl:SingleValue" id="2731c2a1-f70b-4db8-9f70-f531121d3745" value="8.666">
        ...
        <constraint xsi:type="esdl:RangedConstraint" id="d045e8d3-7f7b-40c5-a756-8c6534d6be2b" attributeReference="power" name="NewRangedConstraint">
          <range xsi:type="esdl:Range" id="642eb1f7-22c8-4131-bf90-ff6e387a4a68" minValue="20000.0" name="PV installed capacity range" maxValue="40000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="POWER" description="Power in Watt" id="2b8f2157-4f95-4b2d-8944-cedc43a2cad9" unit="WATT"/>
          </range>
        </constraint>
      ...
      <asset xsi:type="esdl:Export" power="100000.0" name="Export_ef9b" id="ef9b714e-ba35-4efb-9fbd-ff614af32c67">
        ...
        <costInformation xsi:type="esdl:CostInformation">
          <marginalCosts xsi:type="esdl:SingleValue" name="Export_ef9b-MarginalCosts" id="55738e39-2d19-4c33-820c-334de748b2bd" value="0.181"/>
        </costInformation>
