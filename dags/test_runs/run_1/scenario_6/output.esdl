...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" version="14" description="" esdlVersion="v2210" name="New Energy System" id="e4e87ec0-2c1c-4569-afc8-752bbddadbcc">
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="618bbae6-25a7-46d0-bd7d-c1eb70cb2d31">
    <area xsi:type="esdl:Area" id="GM0716" scope="MUNICIPALITY" name="Tholen">
      <asset xsi:type="esdl:PVInstallation" id="1907945a-5ffe-4c08-b9ce-9bc8689f943c" name="PVInstallation_1907" surfaceArea="7979" state="OPTIONAL">
        ...
        <port xsi:type="esdl:OutPort" id="4c3f787e-df4f-4ab8-93ab-93dcde9827e2" connectedTo="ad335aa5-2ebc-4148-85ac-b4276f64b7fc" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out">
          <profile xsi:type="esdl:InfluxDBProfile" startDate="2019-01-01T00:00:00.000000+0100" database="energy_profiles" host="http://influxdb" id="6fc38691-9d02-4f58-bfde-455eb641cb82" measurement="standard_profiles" filters="" multiplier="28813.72" endDate="2020-01-01T00:00:00.000000+0100" port="8086" field="Zon_deBilt">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" id="9d70cc41-750c-4c77-9f80-4bd89bc9020b" description="Energy in kWh" multiplier="KILO" unit="WATTHOUR"/>
          </profile>
        </port>
        <costInformation xsi:type="esdl:CostInformation" id="c1ec6af9-b62b-40db-acdc-a84a7d2692ee">
          ...
          <investmentCosts xsi:type="esdl:SingleValue" id="2731c2a1-f70b-4db8-9f70-f531121d3745" value="24.927">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="ed551dad-660a-4f65-84c6-3e108241a178" description="Cost in EUR/kW" perMultiplier="KILO" perUnit="WATT" unit="EURO"/>
          </investmentCosts>
        </costInformation>
        <constraint xsi:type="esdl:RangedConstraint" name="NewRangedConstraint" id="d045e8d3-7f7b-40c5-a756-8c6534d6be2b" attributeReference="power">
          <range xsi:type="esdl:Range" id="642eb1f7-22c8-4131-bf90-ff6e387a4a68" minValue="20000.0" name="PV installed capacity range" maxValue="40000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Power in Watt" id="2b8f2157-4f95-4b2d-8944-cedc43a2cad9" unit="WATT" physicalQuantity="POWER"/>
          </range>
        </constraint>
      </asset>
      <asset xsi:type="esdl:ElectricityDemand" id="2f528ef6-186e-4937-9967-d277f78e858a" name="ElectricityDemand_2f52">
        ...
        <port xsi:type="esdl:InPort" connectedTo="bdb51e39-6cbf-48b1-84ab-bc342c4449f0" id="54c99cc4-fbc2-4d94-bc78-994eedb2cded" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="In">
          <profile xsi:type="esdl:InfluxDBProfile" startDate="2018-12-31T23:00:00.000000+0000" database="energy_profiles" host="http://influxdb" id="0de8679f-b0c1-4b17-830e-25955007bb2c" measurement="standard_profiles" filters="" multiplier="100.0" endDate="2019-12-31T22:00:00.000000+0000" port="8086" field="E3C">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" id="5cd6a897-1ee4-4963-ac07-e4d917c65ab7" description="Energy in GJ" multiplier="GIGA" unit="JOULE"/>
          </profile>
        </port>
      </asset>
      ...
      <asset xsi:type="esdl:Export" id="ef9b714e-ba35-4efb-9fbd-ff614af32c67" power="100000.0" name="Export_ef9b">
        ...
        <costInformation xsi:type="esdl:CostInformation">
          <marginalCosts xsi:type="esdl:SingleValue" id="55738e39-2d19-4c33-820c-334de748b2bd" name="Export_ef9b-MarginalCosts" value="0.097"/>
        </costInformation>
  ...
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="bc6a175b-6e55-44b4-a664-d0fda633920a">
    <quantityAndUnits xsi:type="esdl:QuantityAndUnits" id="543ca49f-c1bf-4f20-95e6-3dd6e2bc2e28">
      <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" id="eb07bccb-203f-407e-af98-e687656a221d" description="Energy in kWh per kW" perMultiplier="KILO" multiplier="KILO" perUnit="WATT" unit="WATTHOUR"/>
      <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" id="1a81a2e7-6ad4-472a-b8e5-973f82f454e9" description="Energy in GJ" multiplier="GIGA" unit="JOULE"/>
    </quantityAndUnits>
