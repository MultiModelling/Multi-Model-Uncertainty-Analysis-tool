    ...
    <area xsi:type="esdl:Area" id="GM0716" name="Tholen" scope="MUNICIPALITY">
      <asset xsi:type="esdl:PVInstallation" name="PVInstallation_1907" surfaceArea="7979" state="OPTIONAL" id="1907945a-5ffe-4c08-b9ce-9bc8689f943c">
        <costInformation xsi:type="esdl:CostInformation" id="c1ec6af9-b62b-40db-acdc-a84a7d2692ee">
          ...
          <investmentCosts xsi:type="esdl:SingleValue" value="33.252" id="2731c2a1-f70b-4db8-9f70-f531121d3745">
        ...
        <constraint xsi:type="esdl:RangedConstraint" attributeReference="power" name="NewRangedConstraint" id="d045e8d3-7f7b-40c5-a756-8c6534d6be2b">
          <range xsi:type="esdl:Range" minValue="20000.0" name="PV installed capacity range" maxValue="40000.0" id="642eb1f7-22c8-4131-bf90-ff6e387a4a68">
        ...
        <port xsi:type="esdl:OutPort" connectedTo="ad335aa5-2ebc-4148-85ac-b4276f64b7fc" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out" id="4c3f787e-df4f-4ab8-93ab-93dcde9827e2">
          <profile xsi:type="esdl:InfluxDBProfile" measurement="standard_profiles" multiplier="28813.72" endDate="2020-01-01T00:00:00.000000+0100" filters="" port="8086" field="Zon_deBilt" database="energy_profiles" startDate="2019-01-01T00:00:00.000000+0100" id="6fc38691-9d02-4f58-bfde-455eb641cb82" host="http://influxdb">
      ...
      <asset xsi:type="esdl:ElectricityDemand" name="ElectricityDemand_2f52" id="2f528ef6-186e-4937-9967-d277f78e858a">
        <port xsi:type="esdl:InPort" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="In" connectedTo="bdb51e39-6cbf-48b1-84ab-bc342c4449f0" id="54c99cc4-fbc2-4d94-bc78-994eedb2cded">
          <profile xsi:type="esdl:InfluxDBProfile" measurement="standard_profiles" multiplier="100.0" endDate="2019-12-31T22:00:00.000000+0000" filters="" port="8086" field="E3C" database="energy_profiles" startDate="2018-12-31T23:00:00.000000+0000" id="0de8679f-b0c1-4b17-830e-25955007bb2c" host="http://influxdb">
